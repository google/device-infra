...
/** Unit tests for {@link UdclusterLogHandler}. */
@RunWith(JUnit4.class)
public class UdclusterLogHandlerTest {
  ...
  private UdclusterLogHandler udclusterLogHandler;

  @Before
  public void setUp() throws Exception {
    udclusterLogHandler = new UdclusterLogHandler(logEntryQueue, logEntryUtil);
  }
  ...
  public void publish_success() {
    ...
    udclusterLogHandler.publish(LOG_RECORD);
