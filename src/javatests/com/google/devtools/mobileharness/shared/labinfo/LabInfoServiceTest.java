...
public class LabInfoServiceTest {
  ...
  @Test
  public void getLabInfo_deviceView_group_singleStatus() throws Exception {
    DeviceGroupOperation deviceGroupOperation =
        DeviceGroupOperation.newBuilder()
            .setDeviceGroupCondition(
                DeviceGroupCondition.newBuilder()
    ...
    DeviceGroupResult deviceGroupResult =
        DeviceGroupResult.newBuilder()
            .setDeviceGroupOperation(deviceGroupOperation)
            .setDeviceGroupTotalCount(9)
            .addDeviceGroup(
                DeviceGroup.newBuilder()
                    .setDeviceGroupKey(
                        DeviceGroupKey.newBuilder()
                            .setHasStatus(HasStatus.newBuilder().setStatus(DeviceStatus.INIT)))
                    .setGroupedDevices(
                        GroupedDevices.newBuilder()
            ...
            .addDeviceGroup(
                DeviceGroup.newBuilder()
                    .setDeviceGroupKey(
                        DeviceGroupKey.newBuilder()
                            .setHasStatus(HasStatus.newBuilder().setStatus(DeviceStatus.IDLE)))
                    .setGroupedDevices(
                        GroupedDevices.newBuilder()
                            .setDeviceList(
                                DeviceList.newBuilder()
            ...
            .addDeviceGroup(
                DeviceGroup.newBuilder()
                    .setDeviceGroupKey(
                        DeviceGroupKey.newBuilder()
                            .setHasStatus(HasStatus.newBuilder().setStatus(DeviceStatus.BUSY)))
                    .setGroupedDevices(
                        GroupedDevices.newBuilder()
                            .setDeviceList(
                                DeviceList.newBuilder()
            ...
            .addDeviceGroup(
                DeviceGroup.newBuilder()
                    .setDeviceGroupKey(
                        DeviceGroupKey.newBuilder()
                            .setHasStatus(HasStatus.newBuilder().setStatus(DeviceStatus.DYING)))
                    .setGroupedDevices(
                        GroupedDevices.newBuilder()
                            .setDeviceList(DeviceList.newBuilder().setDeviceTotalCount(0))))
            .addDeviceGroup(
                DeviceGroup.newBuilder()
                    .setDeviceGroupKey(
                        DeviceGroupKey.newBuilder()
                            .setHasStatus(HasStatus.newBuilder().setStatus(DeviceStatus.PREPPING)))
                    .setGroupedDevices(
                        GroupedDevices.newBuilder()
                            .setDeviceList(DeviceList.newBuilder().setDeviceTotalCount(0))))
            .addDeviceGroup(
                DeviceGroup.newBuilder()
                    .setDeviceGroupKey(
                        DeviceGroupKey.newBuilder()
                            .setHasStatus(HasStatus.newBuilder().setStatus(DeviceStatus.DIRTY)))
                    .setGroupedDevices(
                        GroupedDevices.newBuilder()
                            .setDeviceList(DeviceList.newBuilder().setDeviceTotalCount(0))))
            .addDeviceGroup(
                DeviceGroup.newBuilder()
                    .setDeviceGroupKey(
                        DeviceGroupKey.newBuilder()
                            .setHasStatus(HasStatus.newBuilder().setStatus(DeviceStatus.LAMEDUCK)))
                    .setGroupedDevices(
                        GroupedDevices.newBuilder()
                            .setDeviceList(DeviceList.newBuilder().setDeviceTotalCount(0))))
            .addDeviceGroup(
                DeviceGroup.newBuilder()
                    .setDeviceGroupKey(
                        DeviceGroupKey.newBuilder()
                            .setHasStatus(HasStatus.newBuilder().setStatus(DeviceStatus.MISSING)))
                    .setGroupedDevices(
                        GroupedDevices.newBuilder()
                            .setDeviceList(DeviceList.newBuilder().setDeviceTotalCount(0))))
            .addDeviceGroup(
                DeviceGroup.newBuilder()
                    .setDeviceGroupKey(
                        DeviceGroupKey.newBuilder()
                            .setHasStatus(HasStatus.newBuilder().setStatus(DeviceStatus.FAILED)))
                    .setGroupedDevices(
                        GroupedDevices.newBuilder()
                            .setDeviceList(DeviceList.newBuilder().setDeviceTotalCount(0))))
            .build();
  ...
  @Test
  public void getLabInfo_deviceView_group_multipleDeviceGroupOperations() throws Exception {
    DeviceGroupOperation deviceGroupOperationByOwnerList =
        DeviceGroupOperation.newBuilder()
            .setDeviceGroupCondition(
                DeviceGroupCondition.newBuilder().setOwnerList(OwnerList.getDefaultInstance()))
            .build();
    DeviceGroupOperation deviceGroupOperationByExecutorList =
        DeviceGroupOperation.newBuilder()
            .setDeviceGroupCondition(
                DeviceGroupCondition.newBuilder()
                    .setExecutorList(ExecutorList.getDefaultInstance()))
            ...
            GetLabInfoRequest.newBuilder()
                .setLabQuery(
                    LabQuery.newBuilder()
                        .setDeviceViewRequest(
                            DeviceViewRequest.newBuilder()
                                .addDeviceGroupOperation(deviceGroupOperationByOwnerList)
                                .addDeviceGroupOperation(deviceGroupOperationByExecutorList)))
                .build());

    DeviceGroupResult deviceGroupResult =
        DeviceGroupResult.newBuilder()
            .setDeviceGroupOperation(deviceGroupOperationByOwnerList)
            .setDeviceGroupTotalCount(2)
            .addDeviceGroup(
                DeviceGroup.newBuilder()
                    .setDeviceGroupKey(
                    ...
                    .setGroupedDevices(
                        GroupedDevices.newBuilder()
                            .setDeviceGroupResult(
                                DeviceGroupResult.newBuilder()
                                    .setDeviceGroupOperation(deviceGroupOperationByExecutorList)
                                    .setDeviceGroupTotalCount(1)
                                    .addDeviceGroup(
                                        DeviceGroup.newBuilder()
                                            .setDeviceGroupKey(
