...
public class XmlWriterTest {
  ...
  public void emptyDocument() throws Exception {
    ...
    assertHasContents("<?xml version='1.0' encoding='UTF-8'?>", "<DocumentName />");
  }
  ...
  public void emptyDocumentWithOneAttribute() throws Exception {
    ...
    assertHasContents("<?xml version='1.0' encoding='UTF-8'?>", "<Properties name='value' />");
  }
  ...
  public void emptyDocumentWithTwoAttributes() throws Exception {
    ...
    assertHasContents(
        "<?xml version='1.0' encoding='UTF-8'?>", "<TestSuite count='7' size='large' />");
  }
  ...
  @Test
  public void documentWithOneElementWithCharactersNoEscaping() throws Exception {
    XmlWriter xmlWriter = new XmlWriter(outputStream);
    xmlWriter.startDocument();
    xmlWriter.startElement("Root");
    xmlWriter.startElement("Child");
  ...
  @Test
  public void documentWithOneElementWithCharactersNeedingEscaping() throws Exception {
    XmlWriter xmlWriter = new XmlWriter(outputStream);
    xmlWriter.startDocument();
    xmlWriter.startElement("Root");
    xmlWriter.startElement("Child");
  ...
  public void attributeValuesEscaped() throws Exception {
    ...
    assertHasContents("<?xml version='1.0' encoding='UTF-8'?>", "<Expression name='a &gt; b' />");
  }
