...
import com.google.devtools.mobileharness.shared.util.base.TestDataProto.Foo;
...
public final class ProtoReflectionUtilTest {
  ...
  @Test
  public void newInstance_throwCastException() {
    assertThrows(
        ClassCastException.class,
        () -> ProtoReflectionUtil.newInstance(Foo.class, Bar.Builder.class));
  }
}
