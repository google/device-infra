...
public final class MaskUtilsTest {
                                ...
                                DeviceList.newBuilder()
                                    ...
                                    .addDeviceInfo(
                                        DeviceInfo.newBuilder()
                                            .setDeviceLocator(
                                                DeviceLocator.newBuilder().setId("device1"))
                                            .setDeviceStatus(DeviceStatus.IDLE)
                                            .build())
                                    .addDeviceInfo(
                                        DeviceInfo.newBuilder()
                                            .setDeviceLocator(
                                                DeviceLocator.newBuilder().setId("device2"))
                        ...
                        LabData.newBuilder()
                            .setLabInfo(
                                LabInfo.newBuilder()
                                    ...
                                    .setLabServerSetting(LabServerSetting.getDefaultInstance())
                                    .setLabServerFeature(LabServerFeature.getDefaultInstance()))
                            .setDeviceList(DeviceList.newBuilder().setDeviceTotalCount(2)))
                    .addLabData(
                        LabData.newBuilder()
                            .setLabInfo(
                                LabInfo.newBuilder()
            ...
            .setDeviceInfoMask(
                DeviceInfoMask.newBuilder()
                    ...
                    .setSupportedDimensionsMask(
                        DimensionsMask.newBuilder().addDimensionNames("pool").build()))
            .build();
  ...
  @Test
  public void trimLabQueryResult_withRequiredDimensionMask() {
    LabQueryResult.Builder resultToTrim = LAB_QUERY_RESULT_WITH_LAB_VIEW.toBuilder();
    Mask mask =
        Mask.newBuilder()
            .setLabInfoMask(LabInfoMask.newBuilder().setFieldMask(FieldMask.getDefaultInstance()))
  ...
  @Test
  public void trimLabQueryResult_withEmpty_returnsOriginalResult() {
    LabQueryResult.Builder resultToTrim = LAB_QUERY_RESULT_WITH_LAB_VIEW.toBuilder();
    Mask mask =
        Mask.newBuilder()
            .setDeviceInfoMask(
                // SupportedDimensionsMask is empty, and RequiredDimensionsMask is not set.
                DeviceInfoMask.newBuilder()
