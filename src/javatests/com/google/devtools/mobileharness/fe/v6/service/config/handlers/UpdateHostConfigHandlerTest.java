...
public final class UpdateHostConfigHandlerTest {
  ...
  private static final Universe UNSUPPORTED_UNIVERSE =
      Universe.newBuilder()
          .setRoutedUniverse(RoutedUniverse.newBuilder().setAtsControllerId("unsupported").build())
          .build();
  ...
  @Test
  public void updateHostConfig_hostProperties_preservesDeviceConfigMode() throws Exception {
    String hostName = "test_host";
    String universe = "google_1p";
    HostConfig feConfig =
        HostConfig.newBuilder()
  ...
  @Test
  public void updateHostConfig_deviceConfigMode_preservesOtherProperties() throws Exception {
    String hostName = "host";
    LabConfig existingLabConfig =
        LabConfig.newBuilder()
            .setHostProperties(
  ...
  @Test
  public void updateHostConfig_deviceConfigMode_toPerDevice_removesProperty() throws Exception {
    String hostName = "host";
    LabConfig existingLabConfig =
        LabConfig.newBuilder()
            .setHostProperties(
  ...
  @Test
  public void updateHostConfig_hostPermissions_syncsToDeviceOwner() throws Exception {
    String hostName = "host";
    UpdateHostConfigRequest request =
        UpdateHostConfigRequest.newBuilder()
            .setHostName(hostName)
