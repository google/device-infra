...
public final class GetDeviceConfigHandlerTest {
  ...
  public void getDeviceConfig_success() throws Exception {
    GetDeviceConfigRequest request = GetDeviceConfigRequest.getDefaultInstance();
    assertThat(getDeviceConfigHandler.getDeviceConfig(request).get())
        .isEqualTo(GetDeviceConfigResponse.getDefaultInstance());
  }
}
