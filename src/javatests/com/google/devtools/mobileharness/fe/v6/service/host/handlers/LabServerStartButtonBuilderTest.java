...
public final class LabServerStartButtonBuilderTest {
  ...
  public void build_featureDisabled_returnsInvisibleAndDoesNotCheckReadiness() {
    ...
    var result = labServerStartButtonBuilder.build(UNIVERSE);

    verify(mockFeatureReadiness, never()).isLabServerStartReady();
  ...
  public void build_featureEnabled_returnsInvisibleAndChecksReadiness() {
    ...
    verify(mockFeatureReadiness).isLabServerStartReady();
    assertThat(result.getVisible()).isFalse();
