...
public final class TroubleshootScriptHandlerTest {
  ...
  @Test
  public void runTroubleshootScript_deviceBusy_fails() throws Exception {
    RunTroubleshootScriptRequest request =
        RunTroubleshootScriptRequest.newBuilder()
            .setHostName("host")
            .setScript(TroubleshootScript.RESET_USB_HUB)
    ...
    assertThat(e)
        .hasCauseThat()
        .hasMessageThat()
        .contains("Cannot run troubleshoot script while devices are BUSY");
  }
