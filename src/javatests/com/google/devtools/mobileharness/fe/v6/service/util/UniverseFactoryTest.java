...
public final class UniverseFactoryTest {
  ...
  public void create_internal_emptyUniverse_returnsSelfUniverse() {
    ...
    Universe universe = universeFactory.create("");

    assertThat(universe.getSelfUniverse()).isEqualTo(SelfUniverse.getDefaultInstance());
  }
  ...
  public void create_internal_google1pUniverse_returnsSelfUniverse() {
    ...
    Universe universe = universeFactory.create("google_1p");
  ...
  public void create_internal_otherUniverse_returnsRoutedUniverse() {
    ...
    Universe universe = universeFactory.create("my_universe");

    assertThat(universe.getRoutedUniverse().getAtsControllerId()).isEqualTo("my_universe");
  }
