...
public class NoOpConfigurationProviderTest {
  ...
  public void getDeviceConfig_returnEmpty() throws Exception {
    assertThat(provider.getDeviceConfig("device_id", Universe.getDefaultInstance()).get())
        .isEmpty();
  }

  @Test
  public void getLabConfig_returnEmpty() throws Exception {
    assertThat(provider.getLabConfig("host_name", Universe.getDefaultInstance()).get()).isEmpty();
  }
