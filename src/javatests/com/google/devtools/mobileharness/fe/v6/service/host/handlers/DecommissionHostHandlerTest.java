...
public final class DecommissionHostHandlerTest {
  ...
  @Test
  public void decommissionHost_routedUniverse_noCalls() throws Exception {
    DecommissionHostRequest request =
        DecommissionHostRequest.newBuilder().setHostName("test_host").build();

    DecommissionHostResponse response =
        handler
  ...
  @Test
  public void decommissionHost_atsEnvironment_throwsUnsupported() {
    ...
    assertThrows(
        ...
        () -> handler.decommissionHost(request, UniverseScope.SELF));
  }
}
