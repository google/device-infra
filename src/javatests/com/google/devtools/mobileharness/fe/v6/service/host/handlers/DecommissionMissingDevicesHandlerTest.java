...
public final class DecommissionMissingDevicesHandlerTest {
  ...
  @Test
  public void decommissionMissingDevices_returnsDefaultInstance() throws Exception {
    ...
    DecommissionMissingDevicesResponse response = handler.decommissionMissingDevices(request).get();
