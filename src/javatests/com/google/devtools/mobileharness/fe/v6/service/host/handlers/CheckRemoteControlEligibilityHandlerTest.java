...
public final class CheckRemoteControlEligibilityHandlerTest {
  ...
  @Inject private CheckRemoteControlEligibilityHandler handler;
  ...
  @Test
  public void checkRemoteControlEligibility_returnsDefaultInstance() throws Exception {
    ...
    CheckRemoteControlEligibilityResponse response =
        handler.checkRemoteControlEligibility(request).get();
