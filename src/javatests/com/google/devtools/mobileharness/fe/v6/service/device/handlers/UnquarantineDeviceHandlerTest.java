...
public final class UnquarantineDeviceHandlerTest {
  ...
  @Inject private UnquarantineDeviceHandler unquarantineDeviceHandler;
  ...
  @Test
  public void unquarantineDevice_success() throws Exception {
    String deviceId = "device_id";
    String hostName = "host_name";
    String universe = "google_1p";
    UnquarantineDeviceRequest request =
        UnquarantineDeviceRequest.newBuilder().setId(deviceId).setUniverse(universe).build();
    ...
    UnquarantineDeviceResponse response =
        unquarantineDeviceHandler.unquarantineDevice(request, UniverseScope.SELF).get();
    ...
    assertThat(upsertRequest.getDurationMs()).isEqualTo(60 * 1000L);
  }

  @Test
  public void unquarantineDevice_notInternal_fails() throws Exception {
    when(environment.isGoogleInternal()).thenReturn(false);
    UnquarantineDeviceRequest request = UnquarantineDeviceRequest.getDefaultInstance();
  ...
  @Test
  public void unquarantineDevice_routedUniverse_fails() throws Exception {
    UnquarantineDeviceRequest request = UnquarantineDeviceRequest.getDefaultInstance();
        ...
        assertThrows(
            ...
            () ->
                unquarantineDeviceHandler
                    .unquarantineDevice(request, new UniverseScope.RoutedUniverse("remote_id"))
                    .get());
    assertThat(e).hasCauseThat().isInstanceOf(IllegalArgumentException.class);
