...
public final class FirstAllocationTest {
  ...
  public void setUp() throws Exception {
    ...
    executor =
        MoreExecutors.listeningDecorator(ThreadPools.createStandardThreadPool("test_thread_pool"));
  }
  ...
  public void runJobs_firstTestAllocated() throws Exception {
    ...
    SessionDetailHolder sessionDetailHolder =
        new SessionDetailHolder(SessionDetail.getDefaultInstance(), () -> {}, null, null);
