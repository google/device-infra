...
public class DeviceConditionUtilTest {
  ...
  @Test
  public void calculateHealthCategory_androidBusyRecovery_returnsAutoRecovery() {
    DeviceDao device =
        createDevice(
            DeviceStatus.BUSY,
            ImmutableList.of("AndroidRealDevice"),
            TestLocator.newBuilder()
                ...
                .build());
    assertThat(DeviceConditionUtil.calculateHealthCategory(device))
        .isEqualTo(HealthCategory.IN_AUTO_RECOVERY);
  }
  ...
  public void calculateHealthCategory_androidInit_returnsTransition() {
    ...
    assertThat(DeviceConditionUtil.calculateHealthCategory(device))
        .isEqualTo(HealthCategory.IN_TRANSITION);
  }
  ...
  @Test
  public void calculateHealthCategory_androidFastbootTypeWithRecovery_returnsAutoRecovery() {
    DeviceDao device =
        createDevice(
            DeviceStatus.IDLE,
  ...
  @Test
  public void calculateHealthCategory_androidRecoveryTypeWithRecovery_returnsAutoRecovery() {
    DeviceDao device =
        createDevice(
            DeviceStatus.IDLE,
  ...
  @Test
  public void calculateHealthCategory_androidFailedRealDeviceWithRecovery_returnsAutoRecovery() {
    DeviceDao device =
        createDevice(
            DeviceStatus.BUSY,
            ImmutableList.of("FailedAndroidRealDevice", "FailedDevice"),
            TestLocator.newBuilder()
                .setJobLocator(JobLocator.newBuilder().setName("recover_android_device").build())
                .build());
    assertThat(DeviceConditionUtil.calculateHealthCategory(device))
  ...
  @Test
  public void
      calculateHealthCategory_androidRealDeviceWithFailedDeviceRecovery_returnsAutoRecovery() {
    DeviceDao device =
        createDevice(
            DeviceStatus.BUSY,
            ImmutableList.of("AndroidRealDevice"),
  ...
  @Test
  public void
      calculateHealthCategory_androidRealDeviceWithRecoverFailedAndroidDevice_returnsAutoRecovery() {
    DeviceDao device =
        createDevice(
            DeviceStatus.BUSY,
            ImmutableList.of("AndroidRealDevice"),
  ...
  @Test
  public void
      calculateHealthCategory_androidRealDeviceWithRecoverFailedFlashableDevice_returnsAutoRecovery() {
    DeviceDao device =
        createDevice(
            DeviceStatus.BUSY,
            ImmutableList.of("AndroidRealDevice"),
