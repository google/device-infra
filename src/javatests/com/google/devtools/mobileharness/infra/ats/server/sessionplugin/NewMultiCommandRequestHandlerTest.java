...
public final class NewMultiCommandRequestHandlerTest {
  ...
  public void setup() throws Exception {
    ...
    newJobResult = Mockito.mock(com.google.devtools.mobileharness.api.model.job.out.Result.class);
    newTestResult = Mockito.mock(com.google.devtools.mobileharness.api.model.job.out.Result.class);
  ...
  public void handleResultProcessing_zeroTotalTest_treatAsError() throws Exception {
    setUpPassingJobAndTestResults();
    ReportProto.Result.Builder resultBuilder =
        ReportProto.Result.newBuilder()
