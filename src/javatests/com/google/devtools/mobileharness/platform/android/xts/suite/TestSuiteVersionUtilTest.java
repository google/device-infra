...
public final class TestSuiteVersionUtilTest {
  ...
  public void parse_fromValidVersionString_success() {
    assertThat(TestSuiteVersionUtil.parse("16.1_r1")).isEqualTo(create(16, 1, 0, 1));
    assertThat(TestSuiteVersionUtil.parse("16_r1")).isEqualTo(create(16, 0, 0, 1));
    assertThat(TestSuiteVersionUtil.parse("8.0_r26")).isEqualTo(create(8, 0, 0, 26));
    assertThat(TestSuiteVersionUtil.parse("4.0.3_r4")).isEqualTo(create(4, 0, 3, 4));
    assertThat(TestSuiteVersionUtil.parse("10_R2")).isEqualTo(create(10, 0, 0, 2));
    assertThat(TestSuiteVersionUtil.parse("6.0")).isEqualTo(create(6, 0, 0, 0));
    assertThat(TestSuiteVersionUtil.parse("16.1")).isEqualTo(create(16, 1, 0, 0));
    assertThat(TestSuiteVersionUtil.parse("15_sts-r46")).isEqualTo(create(15, 0, 0, 46));
  }
  ...
  public void compare_success() {
    TestSuiteVersion version10r1 = create(10, 0, 0, 1);
    TestSuiteVersion version9r2 = create(9, 0, 0, 2);
    TestSuiteVersion version10dot1r1 = create(10, 1, 0, 1);
    TestSuiteVersion version10dot0dot1r1 = create(10, 0, 1, 1);
    TestSuiteVersion version10r2 = create(10, 0, 0, 2);
    ...
    assertThat(TestSuiteVersionUtil.compare(version10r1, create(10, 0, 0, 1))).isEqualTo(0);
  ...
  public void compare_nullInputs_throwsException() {
    TestSuiteVersion version = create(10, 0, 0, 1);
