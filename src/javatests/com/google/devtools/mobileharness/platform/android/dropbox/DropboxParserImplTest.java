...
public class DropboxParserImplTest {
  ...
  public void getDropboxEntries_dataAppNativeCrash() throws Exception {
    DropboxParser parser = new DropboxParserImpl(DropboxTag.DATA_APP_NATIVE_CRASH);
    List<String> lines =
  ...
  public void getDropboxEntries_dataAppCrash() throws Exception {
    DropboxParser parser = new DropboxParserImpl(DropboxTag.DATA_APP_CRASH);
    List<String> lines =
  ...
  public void getDropboxEntries_dataAppAnr() throws Exception {
    DropboxParser parser = new DropboxParserImpl(DropboxTag.DATA_APP_ANR);
    List<String> lines =
  ...
  public void getDropboxEntries_systemTombstone() throws Exception {
    DropboxParser parser = new DropboxParserImpl(DropboxTag.SYSTEM_TOMBSTONE);
    List<String> lines =
