...
public final class ModuleInstallerTest {
  ...
  private final PackageInfo apexPackageInfo =
      PackageInfo.builder()
          ...
          .setIsApex(true)
          .build();
  private final PackageInfo apkPackageInfo =
      PackageInfo.builder()
  ...
  private final File train1 = new File("train1.zip");
  private final File train2 = new File("train2.zip");
  ...
  @Test
  public void installModules_installApks_reboot() throws Exception {
  ...
  @Test
  public void installModules_installApkAndApex_reboot() throws Exception {
  ...
  @Test
  public void installModules_installApksFail_throwException() throws Exception {
  ...
  @Test
  public void sideloadTrains_installTwoTrains_rebootTwice() throws Exception {
  ...
  @Test
  public void sideloadTrains_throwException() throws Exception {
