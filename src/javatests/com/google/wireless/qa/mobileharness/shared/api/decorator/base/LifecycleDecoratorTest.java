...
public final class LifecycleDecoratorTest {
  ...
  public void run_setupThrowsException_runsTeardownAndLogsFailure() throws Exception {
    ...
    doThrow(exception).when(decorator).setUp(any(SetupContext.class));
  ...
  public void run_teardownThrowsException_bubblesExceptionAndLogsFailure() throws Exception {
    ...
    doThrow(exception).when(decorator).tearDown(any(TeardownContext.class));
  ...
  public void run_driverAndTeardownThrowException_suppressesTeardownExceptionAndLogsFailure()
    ...
    doThrow(teardownException).when(decorator).tearDown(any(TeardownContext.class));
