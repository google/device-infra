...
import static com.google.wireless.qa.mobileharness.shared.api.spec.AndroidChromeDriverProviderDecoratorSpec.FILE_CHROMEDRIVER;
import static com.google.wireless.qa.mobileharness.shared.api.spec.AndroidChromeDriverProviderDecoratorSpec.FILE_CHROMEDRIVER_BINARIES;
...
import static com.google.wireless.qa.mobileharness.shared.api.validator.job.AndroidChromeDriverProviderDecoratorJobValidator.ERROR_CUSTOM_CHROMEDRIVER_NOT_ALLOWED;
...
public class AndroidChromeDriverProviderDecoratorJobValidatorTest {
  ...
  @Test
  public void validate_whitespaceTargetType_success() throws Exception {
    jobInfo.params().add(PARAM_TARGET_TYPE, "   ");
  ...
  @Test
  public void validate_customChromedriverFile_returnsError() throws Exception {
    String customDriver = tempFolder.newFile("custom_chromedriver").getAbsolutePath();
    jobInfo.files().add(FILE_CHROMEDRIVER, customDriver);

    assertThat(validator.validate(jobInfo)).containsExactly(ERROR_CUSTOM_CHROMEDRIVER_NOT_ALLOWED);
  }

  @Test
  public void validate_customChromedriverBinariesFile_returnsError() throws Exception {
    String customDriver = tempFolder.newFile("custom_chromedriver").getAbsolutePath();
    jobInfo.files().add(FILE_CHROMEDRIVER_BINARIES, customDriver);

    assertThat(validator.validate(jobInfo)).containsExactly(ERROR_CUSTOM_CHROMEDRIVER_NOT_ALLOWED);
  }

  @Test
  public void validate_customChromedriverPathParam_returnsError() throws Exception {
    jobInfo.params().add("chromedriver_path", "/tmp/custom_chromedriver");
