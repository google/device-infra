...
public class BaseWebTestDriverTest {
  ...
  public void helperGetters_resolveFromParamsAndProperties() {
    ...
    assertThat(driver.getSeleniumAddress(testInfo)).hasValue("http://hub:4444");
    assertThat(driver.getDebuggerAddress(testInfo)).hasValue("127.0.0.1:9222");
    assertThat(driver.getBaseUrl(testInfo)).hasValue("https://example.com");
  }
}
