...
public final class TeardownOnlyDecoratorTest {
  ...
  private TeardownOnlyDecorator decorator;

  private static class MyTeardownOnlyDecorator extends TeardownOnlyDecorator {
    private MyTeardownOnlyDecorator(Driver decorated, TestInfo testInfo) {
  ...
  @Test
  public void run_callsDriverAndTearDown() throws Exception {
    decorator = Mockito.spy(new MyTeardownOnlyDecorator(decorated, testInfo));
