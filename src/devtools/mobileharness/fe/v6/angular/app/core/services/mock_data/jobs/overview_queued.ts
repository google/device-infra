...
export const SCENARIO_JOB_QUEUED: MockJobScenario = {
  ...
  cloudLogLink:
    'https://console.cloud.example.com/logs/query;query=resource.type%3D%22mobileharness_job%22%20AND%20labels.job_id%3D%2299e8e532-0ac4-4d89-8260-8012626e2e4f%22',
};
