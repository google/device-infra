...
const OVERVIEW_01_DATA: MockHostScenario = {
  hostName: 'host-a-1.example.com',
...
/**
 * Returns the mock scenario for 01.
 */
export function OVERVIEW_01(callCount?: number): MockHostScenario {
  return OVERVIEW_01_DATA;
}
