...
export const SCENARIO_TEST_LONG_NAME: MockTestScenario = {
  ...
  overview: {
    id: 'e89a90bf-ec5f-4fcc-b0cd-571097e234c0',
    ...
    result: 'PASS',
    user: 'dafeni',
    jobId: 'd789e532-0bc4-4d89-8260-8012626e2e4f',
    jobName:
      'com.google.android.apps.someteam.super.long.package.name.indicating.deep.hierarchy.for.this.particular.test.suite.manifest.class',
    jobStatus: 'Done',
    jobResult: 'PASS',
