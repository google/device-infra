 ...
 * The keys are dimension names, and the values are arrays of dimension values.
 */
 ...
 * and further grouped by their origin source.
 */
export interface Dimensions {
  /**
   * Dimensions that describe the device's capabilities or attributes.
   * Organized by source, e.g., "From Device Config", "Detected by OmniLab".
   */
  supported: Record<string, DimensionSourceGroup>;
  /**
   * Dimensions that a test job MUST specify to be allocated this device.
   * Organized by source, e.g., "From Device Config", "From Host Config".
   */
  required: Record<string, DimensionSourceGroup>;
}
