...
import {SelectOption} from '@deviceinfra/app/core/models/host_config_models';
...
{
  readonly metadataInputs = viewChildren<ElementRef<HTMLInputElement>>('metadataInput');
  ...
  private focusLastRowFirstInput(inputsArray: ReadonlyArray<ElementRef<HTMLInputElement>>) {
