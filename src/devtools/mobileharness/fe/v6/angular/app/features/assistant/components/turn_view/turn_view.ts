...
import {MutationConfirmCardComponent} from '../mutation_confirm_card/mutation_confirm_card';
...
export class TurnViewComponent {
  ...
  /** Emits when an operator approves a pending action confirmation card. */
  readonly actionApproved = output<ActionConfirmationRequest>();

  /** Emits when an operator rejects a pending action confirmation card. */
  readonly actionRejected = output<ActionConfirmationRequest>();
