...
import {DataTable} from 'google3/third_party/javascript/gviz/data/datatable';
import {ColumnChart} from 'google3/third_party/javascript/gviz/visualization/corechart/corecharts';
...
export class HealthStatisticTab implements OnInit, OnDestroy {
  ...
  private drawChart<T extends {date: string}>(
    ...
    new ColumnChart(element.nativeElement).draw(data, options);
  }
}
