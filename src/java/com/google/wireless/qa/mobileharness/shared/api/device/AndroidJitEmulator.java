...
public class AndroidJitEmulator extends AndroidDevice {
  ...
  public void setUp() throws MobileHarnessException, InterruptedException {
    ...
    addSupportedDecorator("AndroidInstallMainlineModulesDecorator");
  ...
  public void preRunTest(TestInfo testInfo) throws MobileHarnessException, InterruptedException {
    ...
    acloudPath = Flags.instance().acloudPath.getNonNull();
    ...
    logger.atInfo().log("unzipHostPkgOutput: %s", unzipHostPkgOutput);
  ...
  private String getInstanceId() {
    return String.valueOf(
        Integer.valueOf(getDeviceId().substring(getDeviceId().length() - 4)) - 6520 + 1);
  }
}
