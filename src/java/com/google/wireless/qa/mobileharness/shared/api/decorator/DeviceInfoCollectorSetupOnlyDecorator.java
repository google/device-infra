...
/**
 * Setup-only decorator of {@link DeviceInfoCollectorDecorator}. See {@link
 * DeviceInfoCollectorDecorator} for more details.
 */
@DecoratorAnnotation(help = "For collecting device info from device.")
public class DeviceInfoCollectorSetupOnlyDecorator extends SetupOnlyDecorator
  ...
  @Inject
  DeviceInfoCollectorSetupOnlyDecorator(
      Driver decorated,
      TestInfo testInfo,
  ...
  protected SetupResult setUp(SetupContext context)
    ...
    // 2. Install the APK and run tests
