...
public interface AndroidInstrumentationDriverSpec {
  ...
  @ParamAnnotation(
      required = false,
      help =
          "Whether to use android instrumentation parsing or gtest XML parsing. By default, this is"
              + " set to use instrumentation parsing.")
  ...
  @ParamAnnotation(
      ...
      help =
          "The path to the gtest XML file on the device. This should be set if"
              + " ignore_instrument_output is true. e.g. /sdcard/Download/test_results.xml")
