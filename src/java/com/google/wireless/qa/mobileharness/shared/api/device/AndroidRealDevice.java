...
import com.google.wireless.qa.mobileharness.shared.android.AndroidUtil;
import com.google.wireless.qa.mobileharness.shared.android.Sqlite;
import com.google.wireless.qa.mobileharness.shared.api.AndroidApiUtil;
...
public class AndroidRealDevice extends AndroidDevice {
  ...
  public AndroidRealDevice(String deviceId) {
    this(deviceId, new AndroidUtil());
  }

  public AndroidRealDevice(String deviceId, AndroidUtil androidUtil) {
    this(
        deviceId,
