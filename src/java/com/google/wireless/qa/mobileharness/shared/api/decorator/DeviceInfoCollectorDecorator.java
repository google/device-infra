...
public class DeviceInfoCollectorDecorator
    extends PhaseSkippableDecorator<
        DeviceInfoCollectorSetupOnlyDecorator, DeviceInfoCollectorTeardownOnlyDecorator>
    implements SpecConfigable<DeviceInfoCollectorDecoratorSpec> {

  @Inject
  DeviceInfoCollectorDecorator(Driver decorated, TestInfo testInfo) throws MobileHarnessException {
