...
/** {@link JobValidator} for AndroidRuntimeStatsDecorator */
public class AndroidRuntimeStatsDecoratorJobValidator
    implements JobValidator, SpecConfigable<AndroidRuntimeStatsDecoratorSpec> {
  ...
  public ImmutableList<String> validate(JobInfo job) throws InterruptedException {
    ...
    List<AndroidRuntimeStatsDecoratorSpec> unused;
    try {
      unused =
          job.combinedSpecForDevices(
              this,
              subDeviceSpec ->
                  subDeviceSpec.decorators().getAll().contains("AndroidRuntimeStatsDecorator"));
