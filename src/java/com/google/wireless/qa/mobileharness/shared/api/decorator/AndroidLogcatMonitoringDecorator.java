...
import static com.google.devtools.mobileharness.platform.android.dropbox.DropboxParser.DropboxTag.DATA_APP_ANR;
import static com.google.devtools.mobileharness.platform.android.dropbox.DropboxParser.DropboxTag.DATA_APP_CRASH;
import static com.google.devtools.mobileharness.platform.android.dropbox.DropboxParser.DropboxTag.DATA_APP_NATIVE_CRASH;
import static com.google.devtools.mobileharness.platform.android.dropbox.DropboxParser.DropboxTag.SYSTEM_APP_ANR;
import static com.google.devtools.mobileharness.platform.android.dropbox.DropboxParser.DropboxTag.SYSTEM_APP_CRASH;
import static com.google.devtools.mobileharness.platform.android.dropbox.DropboxParser.DropboxTag.SYSTEM_APP_NATIVE_CRASH;
import static com.google.devtools.mobileharness.platform.android.dropbox.DropboxParser.DropboxTag.SYSTEM_TOMBSTONE;
...
import com.google.devtools.mobileharness.platform.android.dropbox.DropboxParser.DropboxTag;
...
public class AndroidLogcatMonitoringDecorator extends BaseDecorator
  ...
  private void extractDropboxEntries(TestInfo testInfo)
    ...
    var tagsBuilder = ImmutableList.<DropboxTag>builder();
    var packagesToScanBuilder = ImmutableList.<String>builder();
    for (var event : logcatEvents) {
      if (event instanceof CrashEvent crashEvent) {
