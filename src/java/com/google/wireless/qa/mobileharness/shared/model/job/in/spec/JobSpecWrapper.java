...
/**
 * A java wrapper of Job Specs. You could get any specs with the method {@link #getSpec(Class)}},
 * however the method parameter must be a subclass of {@link SpecConfigable}.
 */
public interface JobSpecWrapper {
   ...
   */
  <T extends Message> T getSpec(Class<T> specClass) throws MobileHarnessException;
}
