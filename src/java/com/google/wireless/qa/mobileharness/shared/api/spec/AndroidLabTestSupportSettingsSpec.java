...
/** Spec for AndroidLabTestSupportSettingsDecorator. */
@SuppressWarnings("InterfaceWithOnlyStatics") // This interface is implemented by some decorators
public interface AndroidLabTestSupportSettingsSpec {

  @FileAnnotation(required = true, help = "File tag for the LabTestSupport APK.")
