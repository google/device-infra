...
package com.google.devtools.mobileharness.shared.util.algorithm;
 ...
 * matchings</a>.
 */
public final class GraphMatching {
   ...
   * returned.
   */
  public static <U, V> ImmutableBiMap<U, V> maximumCardinalityBipartiteMatching(
      Multimap<U, V> graph) {
