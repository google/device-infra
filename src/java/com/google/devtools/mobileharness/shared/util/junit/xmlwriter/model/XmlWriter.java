...
import com.google.devtools.mobileharness.shared.util.junit.xmlwriter.util.XmlEscapers;
...
/**
 * Writer for XML documents. We do not use third-party code, because all java_test rules have the
 * test runner in their run-time classpath.
 */
public class XmlWriter {
  ...
  /**
   * Starts an XML element. The element is left open until either {@link #endElement()} or {@link
   * #close()} are called. This method may be called multiple times before calling {@link
   * #endElement()}; the writer keeps a stack of currently open elements.
   *
  ...
  /**
   * Writes an attribute with the given double value to the currently open XML element.
   *
   * @param name attribute name
  ...
  /**
   * Writes the given characters as the content of the element. Closes the element if it is
   * currently open.
   *
