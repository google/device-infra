...
public class SystemUtil {
  ...
  /** Pattern of UBUNTU version. (e.g. Match "22.04" from "Release: 22.04") */
  private static final Pattern UBUNTU_VERSION_PATTERN = Pattern.compile("Ubuntu ([0-9|\\.]+)");
  ...
  /**
   * Returns Ubuntu's Version. The CommandExecutor runs command "lab_release -a | grep Release" and
   * the output will be 'Release: **.**' (e.g. "Release: 22.04")
   */
