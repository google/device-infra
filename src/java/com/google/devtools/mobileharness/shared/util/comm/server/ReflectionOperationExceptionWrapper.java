...
/** Wraps {@link ReflectiveOperationException}. */
public class ReflectionOperationExceptionWrapper {
  ...
  /** Wraps {@link ReflectiveOperationException} in an IllegalStateException. */
  static IllegalStateException rethrowAsIllegalStateException(ReflectiveOperationException e) {
