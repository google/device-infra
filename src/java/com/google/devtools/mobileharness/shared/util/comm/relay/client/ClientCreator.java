...
public final class ClientCreator {
  ...
  public static Channel createChannel(Channel originalChannel, String destination) {
  ...
  public static <T extends AbstractStub<T>> T createStub(T originalStub, String destination) {
    return originalStub.withInterceptors(createInterceptor(destination));
  }

  static ClientInterceptor createInterceptor(String destination) {
