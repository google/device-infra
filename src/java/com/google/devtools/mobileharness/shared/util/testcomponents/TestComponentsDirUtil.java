...
/** Utils for dealing with directories for test components. */
public class TestComponentsDirUtil {
  ...
  public TestComponentsDirUtil() {
    this(new LocalFileUtil());
  }

  TestComponentsDirUtil(LocalFileUtil fileUtil) {
