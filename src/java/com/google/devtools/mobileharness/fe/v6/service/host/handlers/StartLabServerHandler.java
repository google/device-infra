...
/** Handler for StartLabServer RPCs. */
public final class StartLabServerHandler {
  private final StartLabServerActionHelper actionHelper;

  @Inject
  StartLabServerHandler(StartLabServerActionHelper actionHelper) {
    this.actionHelper = actionHelper;
  }

  public ListenableFuture<StartLabServerResponse> startLabServer(
      StartLabServerRequest request, UniverseScope universe) {
    return actionHelper.startLabServer(request, universe);
  }
}
