...
public final class AtsOneFleetDataSource implements FleetDataSource {
  ...
  AtsOneFleetDataSource(
      LabInfoFleetPuller labInfoFleetPuller, ConfigurationProvider configurationProvider) {
  ...
  @Override
  public FleetRawData pull() throws ExecutionException {
    LabQueryResult labData = labInfoFleetPuller.pull();
    ImmutableList<String> deviceIds = deviceIds(labData);
    List<DeviceConfig> deviceConfigs =
        Uninterruptibles.getUninterruptibly(
            configurationProvider.getDeviceConfigs(deviceIds, UniverseScope.SELF));
    return FleetRawData.builder()
        .setLabData(labData)
