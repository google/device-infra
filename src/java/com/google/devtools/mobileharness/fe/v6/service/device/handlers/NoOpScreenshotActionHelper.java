...
/** No-op implementation of {@link ScreenshotActionHelper} for OSS environment. */
public final class NoOpScreenshotActionHelper implements ScreenshotActionHelper {
  ...
  public ListenableFuture<TakeScreenshotResponse> takeScreenshot(
    ...
    return immediateFailedFuture(
        new UnsupportedOperationException(
            "Taking screenshot is not supported in the current environment."));
  }
}
