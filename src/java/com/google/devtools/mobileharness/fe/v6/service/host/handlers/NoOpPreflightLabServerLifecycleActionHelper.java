...
/** No-op implementation of {@link PreflightLabServerLifecycleActionHelper}. */
@Singleton
public final class NoOpPreflightLabServerLifecycleActionHelper
    implements PreflightLabServerLifecycleActionHelper {

  @Inject
  NoOpPreflightLabServerLifecycleActionHelper() {}
  ...
  public ListenableFuture<PreflightLabServerLifecycleResponse> preflightLabServerLifecycle(
    ...
    return immediateFailedFuture(
        new UnsupportedOperationException(
            "Preflight lab server lifecycle is not supported in the current environment."));
  }
}
