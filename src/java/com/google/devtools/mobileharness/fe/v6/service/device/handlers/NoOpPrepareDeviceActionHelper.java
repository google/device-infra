...
/** No-op implementation of {@link PrepareDeviceActionHelper} for OSS environment. */
public final class NoOpPrepareDeviceActionHelper implements PrepareDeviceActionHelper {

  @Override
  public ListenableFuture<PrepareDeviceResponse> prepareDevice(
      PrepareDeviceRequest request, UniverseScope universe, String username) {
    return immediateFailedFuture(
        FeServiceException.unimplemented(
            "Preparing device is not supported in the current environment."));
  }
}
