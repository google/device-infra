...
public class LabServerStartButtonBuilder {
  ...
  public ActionButtonState build(
    ...
    // Visible when the activity is a valid Start target; daemon state decides enabled.
    boolean visibleCondition =
        LabServerActionAvailabilities.isTargetActivity(LifecycleActionType.START, releaseStatus);
