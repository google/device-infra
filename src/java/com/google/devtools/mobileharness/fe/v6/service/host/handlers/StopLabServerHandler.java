...
/** Handler for StopLabServer RPCs. */
public final class StopLabServerHandler {
  private final StopLabServerActionHelper actionHelper;

  @Inject
  StopLabServerHandler(StopLabServerActionHelper actionHelper) {
    this.actionHelper = actionHelper;
  }

  public ListenableFuture<StopLabServerResponse> stopLabServer(
      StopLabServerRequest request, UniverseScope universe) {
    return actionHelper.stopLabServer(request, universe);
  }
}
