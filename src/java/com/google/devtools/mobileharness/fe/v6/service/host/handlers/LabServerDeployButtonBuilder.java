...
/** Utility class to build {@link ActionButtonState} for lab server deploy button. */
@Singleton
public class LabServerDeployButtonBuilder {
  ...
  public ActionButtonState build(
    ...
    BooleanSupplier buttonVisibleSupplier =
        () -> featureManagerFactory.create(universe).isLabServerDeployFeatureEnabled();
    BooleanSupplier buttonReadySupplier = () -> featureReadiness.isLabServerDeployReady();
