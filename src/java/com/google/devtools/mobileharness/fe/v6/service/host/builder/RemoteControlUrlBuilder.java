...
/** Builder for generating remote control session URLs. */
public interface RemoteControlUrlBuilder {

  /** Generates the remote control URL for the device. */
  Optional<String> generateRemoteControlUrl(
