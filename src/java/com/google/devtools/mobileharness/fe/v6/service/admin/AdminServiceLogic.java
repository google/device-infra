...
/** Interface for the core logic of the Admin Service. */
public interface AdminServiceLogic {
  ListenableFuture<SetWifiCredentialsResponse> setWifiCredentials(
      SetWifiCredentialsRequest request);

  ListenableFuture<ListWifiCredentialsResponse> listWifiCredentials(
