...
/** Handler for updating pass through flags. */
public final class UpdatePassThroughFlagsHandler {

  private final UpdatePassThroughFlagsActionHelper actionHelper;

  @Inject
  UpdatePassThroughFlagsHandler(UpdatePassThroughFlagsActionHelper actionHelper) {
  ...
  public ListenableFuture<UpdatePassThroughFlagsResponse> updatePassThroughFlags(
    ...
    return actionHelper.updatePassThroughFlags(request, universe);
  }
}
