...
public class AndroidConnectivityUtil {
  ...
  /** Device models that require masked SSID matching behavior. */
  private static final ImmutableSet<String> MASKED_SSID_SUPPORTED_MODELS =
      ImmutableSet.of("rmx2103", "rmx3231");
