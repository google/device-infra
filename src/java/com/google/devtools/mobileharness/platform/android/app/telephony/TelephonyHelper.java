...
public class TelephonyHelper {
  ...
  /**
   * Updates the SIM card type dimension based on the device's SIM card information. The logic is
   * mostly copied from Tradefed:
   * http://google3/third_party/java_src/tradefederation_core/tools/tradefederation/core/src/com/android/tradefed/invoker/shard/token/TelephonyTokenProvider.java;l=53-98;rcl=364381045
   */
