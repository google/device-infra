...
public class DaemonUtil {
  ...
  /** Update device id. */
  public void updateDeviceId(TextView idView, TextView mirroredIdView, String id) {
  ...
  public void updateHostInfo(TextView hostView, String hostname) {
  ...
  public void updateLabelsInfo(TextView labelView, String labels) {
  ...
  public void updateOwnerInfo(TextView ownersView, String owners) {
   ...
   */
  public void updateWifiInfo(TextView wifiView, WifiManager wifiMgr, String explicitSsid) {
   ...
   */
  @SuppressWarnings("HardwareIds")
  public void updatePhoneInfo(TextView phoneView, TelephonyManager telMgr) {
