...
public class GenericServiceManagerTest {
  ...
  @Test
  public void stop_unavailable() throws InterruptedException {
    server.shutdownNow();
    server.awaitTermination();
  ...
  @Test
  public void start_afterClose_throwsException() throws InterruptedException {
    serviceManager.close();
    Map<String, Any> message = new HashMap<>();
    assertThrows(NullPointerException.class, () -> serviceManager.start(message));
  }
}
