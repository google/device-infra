...
/** Interface to process a stream of {@link LogcatLine} */
public interface LineProcessor {

  /** Process the {@code line} */
  void process(LogcatLine line);

  /** Get all the {@link LogcatEvent}s detected by this LineProcessor. */
  ImmutableList<LogcatEvent> getEvents();
}
