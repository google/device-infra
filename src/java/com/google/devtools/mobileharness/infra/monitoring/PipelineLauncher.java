...
import com.google.devtools.mobileharness.infra.monitoring.MonitorModule.LabMonitoringService;
...
public final class PipelineLauncher {
  ...
  @Inject
  PipelineLauncher(@LabMonitoringService BatchPipelineService<MonitorEntry> labMonitorService) {
    this.labMonitorService = labMonitorService;
  }

  /** Starts the monitoring pipelines. */
  public void start() {
    labMonitorService.startAsync().awaitRunning();
  }
}
