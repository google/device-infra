...
import com.google.devtools.mobileharness.infra.master.central.model.lab.LabCondition;
...
public interface LabRepository {
   ...
   */
  public LabCondition getLabCondition(LabLocator labLocator, TransactionContext context)
