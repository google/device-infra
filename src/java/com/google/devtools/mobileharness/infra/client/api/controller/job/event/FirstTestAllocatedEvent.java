...
package com.google.devtools.mobileharness.infra.client.api.controller.job.event;
 ...
 *
 * @param allocatedJob the job that received the first allocation
 */
public record FirstTestAllocatedEvent(JobInfo allocatedJob) {}
