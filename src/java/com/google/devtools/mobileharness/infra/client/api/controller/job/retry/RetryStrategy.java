...
public interface RetryStrategy {
   ...
   *     null, the framework will create a new test attempt with the given reason. not including the
   *     retry. Otherwise, it will be set to 0.
   * @param newTestProperties Properties to be added to the new test attempt if a retry is made.
   */
  public record RetryInfo(
      boolean shouldRetry, Optional<String> retryReason, Map<String, String> newTestProperties) {}

  public static final RetryInfo NO_RETRY =
      new RetryInfo(false, Optional.empty(), ImmutableMap.of());
