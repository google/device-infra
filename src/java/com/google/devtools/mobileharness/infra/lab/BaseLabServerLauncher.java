...
/** Abstract launcher of lab server. */
public abstract class BaseLabServerLauncher {
  ...
  protected abstract ImmutableList<Module> createModules(
  ...
  protected static class NoOpService extends AbstractIdleService {
    @Override
