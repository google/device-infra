...
final class NewMultiCommandRequestHandler {
  ...
  private SessionRequestInfo generateSessionRequestInfo(
    ...
    if (mountedXtsRootDir.isEmpty()) {
      ...
      xtsChunkedTestCasesRestorer.restoreTestCases(
          xtsRootDir, getXtsType(xtsRootDir, androidXtsZipPath));
    }
  ...
  private boolean validateMountedXtsRootDir(String xtsRootDir) {
    ...
    try {
      String chunkedTestcasesDir =
          XtsChunkedTestCasesRestorer.getChunkedTestCasesDir(xtsRootDir, xtsType);
