...
public interface XtsDynamicDownloadPluginInterface {
  /** Parse the device and test info to generate dynamic download file info */
  XtsDynamicDownloadInfo parse(TestInfo test, Device device)
      throws MobileHarnessException, InterruptedException;

  /** Download the xts files based on the download url link */
