...
import com.google.devtools.mobileharness.api.testrunner.event.test.TestStartedEvent;
import com.google.wireless.qa.mobileharness.shared.model.job.TestInfo;

/** Implementation for {@linkplain TestStartedEvent}. */
public record TestStartedEventImpl(
    DeviceFeature deviceFeature,
    ImmutableList<LabQueryProto.DeviceInfo> allDeviceInfos,
    TestInfo test,
    Allocation allocation)
    implements TestStartedEvent {
