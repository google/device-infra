...
package com.google.devtools.mobileharness.infra.controller.test.local.annotation;
...
/**
 * Indicates that a {@linkplain com.google.wireless.qa.mobileharness.shared.api.driver.Driver MH
...
@Retention(RUNTIME)
@Target(TYPE)
public @interface DoNotSubscribeTestEvent {}
