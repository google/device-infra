...
import com.google.devtools.mobileharness.api.testrunner.event.test.LocalTestEndedEvent;
import com.google.wireless.qa.mobileharness.shared.model.job.TestInfo;
import java.util.Optional;

/** Implementation for {@linkplain LocalTestEndedEvent}. */
public record LocalTestEndedEventImpl(
    TestInfo test,
    Allocation allocation,
    DeviceFeature deviceFeature,
    ImmutableList<LabQueryProto.DeviceInfo> allDeviceInfos,
    Optional<Throwable> executionError)
    implements LocalTestEndedEvent {
