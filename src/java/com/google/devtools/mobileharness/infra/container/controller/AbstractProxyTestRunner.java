...
/** Abstract base class for {@link ProxyTestRunner}. */
public abstract class AbstractProxyTestRunner<T extends AbstractProxyTestRunner<T>>
    extends AbstractTestRunner<T> implements ProxyTestRunner {

  private volatile boolean isClosed;

  protected AbstractProxyTestRunner(
