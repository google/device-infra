...
public enum ExtErrorId implements ErrorId {
  ...
  MOBLY_RESULTSTORE_UPLOAD_PRECHECK_FAILED(81_047, ErrorType.CUSTOMER_ISSUE),
  ...
  MOBLY_AOSP_RESOLVE_TEST_EXECUTION_COMMAND_ERROR(81_088, ErrorType.CUSTOMER_ISSUE),
  ...
  // PhaseSkippableDecorator: 83_451 ~ 83_480
  PHASE_SKIPPABLE_DECORATOR_UNKNOWN_EXECUTION_MODE(83_451, ErrorType.CUSTOMER_ISSUE),
  PHASE_SKIPPABLE_DECORATOR_PARSE_STATE_ERROR(83_452, ErrorType.INFRA_ISSUE),
  ...
  // TvosRealDevice: 84_571 - 84_580
  DEVICE_CTL_DEVICE_NOT_PAIRED(84_571, ErrorType.CUSTOMER_ISSUE),
  DEVICE_CTL_DEVICE_DETAIL_NOT_FOUND(84_572, ErrorType.CUSTOMER_ISSUE),
  TVOS_GUNIT_TEST_FAILED(84_573, ErrorType.INFRA_ISSUE),
  TVOS_GUNIT_TEST_ERROR(84_574, ErrorType.UNDETERMINED),
  TVOS_GUNIT_CONVERT_TEST_APP_ERROR(84_575, ErrorType.INFRA_ISSUE),
  ...
  MOBLY_REPORT_PARSER_INVALID_CONVERTER_CLASS_ERROR(87_052, ErrorType.CUSTOMER_ISSUE),
  ...
  PREV_RESULT_LOADER_MISSING_TEST_RESULT_XML_FILE_IN_SESSION(87_413, ErrorType.INFRA_ISSUE),
  ...
  /** Android Desktop: 91_151 ~ 91_200 */
  ANDROID_DESKTOP_RECOVERING_DRIVER_INFRA_ERROR(91_151, ErrorType.INFRA_ISSUE),
  ANDROID_DESKTOP_DEVICE_HELPER_INFRA_ERROR(91_152, ErrorType.INFRA_ISSUE),

  // PythonVersionCheckDecorator: 92_001 ~ 92_050
  PYTHON_VERSION_CHECK_DECORATOR_VERSION_NOT_MATCH(92_001, ErrorType.CUSTOMER_ISSUE),
  ...
  // Android CDP: 92_101 ~ 92_150
  CDP_APP_LAUNCH_ERROR(92_101, ErrorType.DEPENDENCY_ISSUE),
  CDP_CHROMEDRIVER_ERROR(92_102, ErrorType.DEPENDENCY_ISSUE),
  CDP_FLAG_SETUP_ERROR(92_103, ErrorType.INFRA_ISSUE),
  CDP_PARAMETER_ERROR(92_104, ErrorType.CUSTOMER_ISSUE),
  CDP_PORT_ALLOCATION_ERROR(92_105, ErrorType.INFRA_ISSUE),
  CDP_PORT_FORWARD_ERROR(92_106, ErrorType.DEPENDENCY_ISSUE),
  CDP_SCRIPT_ERROR(92_107, ErrorType.CUSTOMER_ISSUE),
