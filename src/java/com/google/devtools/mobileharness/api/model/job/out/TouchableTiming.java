...
public class TouchableTiming extends Timing implements Cloneable {
  ...
  TouchableTiming(TimeDetail timeDetail) {
    super(
        ...
        timeDetail.hasStartTimeMs() ? Instant.ofEpochMilli(timeDetail.getStartTimeMs()) : null);
    this.modifyTime =
        timeDetail.hasModifyTimeMs() ? Instant.ofEpochMilli(timeDetail.getModifyTimeMs()) : null;
  }
