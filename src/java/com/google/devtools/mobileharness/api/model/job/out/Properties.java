...
public class Properties {
  ...
  public Properties(TouchableTiming timing) {
    this.timing = timing;
  }
  ...
  /** Returns the number of the property pairs. */
  public int size() {
  ...
  public Optional<Boolean> getBoolean(String key) {
    ...
    if (StrUtil.isEmptyOrWhitespace(value)) {
      return Optional.empty();
    } else if (Ascii.equalsIgnoreCase(Boolean.TRUE.toString(), value)) {
      return Optional.of(true);
    } else if (Ascii.equalsIgnoreCase(Boolean.FALSE.toString(), value)) {
