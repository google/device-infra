...
public enum AndroidErrorId implements ErrorId {
  ...
  ANDROID_SYSTEM_SETTING_SET_APPOPS_PERMISSION_ERROR(100_067, ErrorType.INFRA_ISSUE),
  ANDROID_SYSTEM_SETTING_GET_BATTERY_CYCLE_COUNT_ERROR(100_068, ErrorType.INFRA_ISSUE),
  ANDROID_SYSTEM_SETTING_GET_BATTERY_STATE_ERROR(100_069, ErrorType.INFRA_ISSUE),
  ...
  ANDROID_INSTRUMENTATION_COMMAND_SIGNATURE_MISMATCH(100_317, ErrorType.CUSTOMER_ISSUE),
  ANDROID_INSTRUMENTATION_UNSUPPORTED_ORCHESTRATOR_VERSION(100_318, ErrorType.CUSTOMER_ISSUE),
  ...
  ANDROID_FILE_UTIL_PUSH_FILE_TIMEOUT(100_879, ErrorType.UNDETERMINED),
  ...
  ANDROID_PKG_MNGR_UTIL_INSTALLATION_FAILED_CONFLICTING_PROVIDER(101_361, ErrorType.CUSTOMER_ISSUE),
  ANDROID_PKG_MNGR_UTIL_INSTALLATION_MISSING_SUCCESS_SIGNAL(101_362, ErrorType.UNDETERMINED),
  ...
  ANDROID_PROCESS_RESOLVE_ACTIVITY_ERROR(101_860, ErrorType.CUSTOMER_ISSUE),
  ...
  // Android Emulator: 109_201 ~ 109_400
  ...
  ANDROID_CLOUD_ORCHESTRATOR_OPERATION_ERROR(109_205, ErrorType.INFRA_ISSUE),
  ANDROID_JIT_EMULATOR_INVALID_DEVICE_ID_ERROR(109_206, ErrorType.INFRA_ISSUE),
  ANDROID_JIT_EMULATOR_INVALID_PARAMETER_ERROR(109_207, ErrorType.CUSTOMER_ISSUE),
  ...
  ANDROID_INSTRUMENTATION_TEST_DEVICE_OFFLINE(115_006, ErrorType.UNDETERMINED),
  ...
  ANDROID_INSTRUMENTATION_WRITE_JUNIT_XML_ERROR(115_026, ErrorType.INFRA_ISSUE),
  ...
  ANDROID_INSTRUMENTATION_LISTER_SHARDING_OPTION_INVALID(115_054, ErrorType.CUSTOMER_ISSUE),
  ANDROID_INSTRUMENTATION_LISTER_SMART_SHARDING_ERROR(115_055, ErrorType.CUSTOMER_ISSUE),
  ...
  XTS_RESTORE_CHUNKED_TEST_CASES_ERROR(115_865, ErrorType.UNDETERMINED),

  // AndroidTestLoopTest driver: 115_951 ~ 115_970
  ANDROID_TEST_LOOP_COMPANION_INSTALL_FAILED(115_951, ErrorType.INFRA_ISSUE),
  ANDROID_TEST_LOOP_COMPANION_APK_NOT_FOUND(115_952, ErrorType.INFRA_ISSUE),
  ANDROID_TEST_LOOP_INSTRUMENTATION_FAILED(115_953, ErrorType.CUSTOMER_ISSUE),
  ANDROID_TEST_LOOP_INSTRUMENTATION_ERROR(115_954, ErrorType.INFRA_ISSUE),

  // AndroidPhoneskyRecoveryModeSafeSelfUpdateDriver: 115_971 ~ 116_000
  ANDROID_PHONESKY_RECOVERY_MODE_SAFE_SELF_UPDATE_LOGCAT_ERROR(115_971, ErrorType.INFRA_ISSUE),
  ANDROID_PHONESKY_RECOVERY_MODE_SAFE_SELF_UPDATE_VERSION_UPGRADE_FAILED(
      115_972, ErrorType.CUSTOMER_ISSUE),
  ANDROID_PHONESKY_RECOVERY_MODE_SAFE_SELF_UPDATE_REQUIRED_SPLIT_MISSING(
      115_973, ErrorType.CUSTOMER_ISSUE),
  ANDROID_PHONESKY_RECOVERY_MODE_SAFE_SELF_UPDATE_EXECUTION_ERROR(
      115_974, ErrorType.CUSTOMER_ISSUE),
  ANDROID_PHONESKY_RECOVERY_MODE_SAFE_SELF_UPDATE_FAIL_TO_DUMPSYS_PHONSKY(
      115_975, ErrorType.DEPENDENCY_ISSUE),
  ANDROID_PHONESKY_RECOVERY_MODE_SAFE_SELF_UPDATE_FAIL_TO_DISABLE_SELF_UPDATE(
      115_976, ErrorType.DEPENDENCY_ISSUE),
  ANDROID_PHONESKY_RECOVERY_MODE_SAFE_SELF_UPDATE_FAIL_TO_TRIGGER_RECOVERY_MODE(
      115_977, ErrorType.DEPENDENCY_ISSUE),
  ANDROID_PHONESKY_RECOVERY_MODE_SAFE_SELF_UPDATE_FAIL_TO_GET_VERSION(
      115_978, ErrorType.DEPENDENCY_ISSUE),
  ANDROID_PHONESKY_RECOVERY_MODE_SAFE_SELF_UPDATE_APK_SETUP_ERROR(
      115_979, ErrorType.CUSTOMER_ISSUE),
  ANDROID_PHONESKY_RECOVERY_MODE_SAFE_SELF_UPDATE_CONFIG_PROTO_PARSE_ERROR(
      115_980, ErrorType.CUSTOMER_ISSUE),
  ...
  ANDROID_FILE_PUSHER_DECORATOR_PUSH_FILE_TIMEOUT(125_010, ErrorType.UNDETERMINED),
  ...
  ANDROID_INSTALL_MAINLINE_MODULES_DECORATOR_PACKAGE_INFO_PARSING_ERROR(
      128_002, ErrorType.CUSTOMER_ISSUE),
  ANDROID_INSTALL_MAINLINE_MODULES_DECORATOR_MODULE_INSTALLATION_FAILURE(
      128_003, ErrorType.CUSTOMER_ISSUE),
  ...
  ANDROID_ATS_DYNAMIC_CONFIG_PUSHER_DECORATOR_INVALID_PARAMETER(
      129_555, ErrorType.DEPENDENCY_ISSUE),
  ...
  ANDROID_MARTIAN_PROXY_DECORATOR_NO_FREE_PORT_ERROR(129_606, ErrorType.INFRA_ISSUE),

  // Android Desktop: 129_851 ~ 129_900
  ANDROID_DESKTOP_OTA_UPDATE_DECORATOR_OTA_UPDATE_ERROR(129_851, ErrorType.DEPENDENCY_ISSUE),
  ANDROID_DESKTOP_OTA_UPDATE_DECORATOR_OTA_TOOLS_UNZIP_ERROR(129_852, ErrorType.DEPENDENCY_ISSUE),
  ANDROID_DESKTOP_OTA_UPDATE_DECORATOR_OTA_UPDATE_SCRIPT_FILE_NOT_FOUND(
      129_853, ErrorType.DEPENDENCY_ISSUE),
  ANDROID_DESKTOP_OTA_UPDATE_DECORATOR_OTA_UPDATE_SCRIPT_NOT_EXECUTABLE_ERROR(
      129_854, ErrorType.DEPENDENCY_ISSUE),
  ANDROID_DESKTOP_OTA_UPDATE_DECORATOR_OTA_UPDATE_PACKAGE_FILE_NOT_EXISTS(
      129_855, ErrorType.DEPENDENCY_ISSUE),
  ...
  ANDROID_LOGCAT_MONITORING_DECORATOR_APP_UNDER_TEST_PROCESS_CRASHED(
      130_054, ErrorType.CUSTOMER_ISSUE),
  ...
  ANDROID_FLASH_GKI_DECORATOR_GET_KERNEL_VERSION_ERROR(130_111, ErrorType.CUSTOMER_ISSUE),
  ANDROID_FLASH_GKI_DECORATOR_KERNEL_NOT_COMPATIBLE(130_112, ErrorType.CUSTOMER_ISSUE),

  // Android HD Video decorator 130_151 ~ 130_200
  ANDROID_HD_VIDEO_DECORATOR_RESOURCE_FILE_ABSENT(130_151, ErrorType.INFRA_ISSUE),

  // AndroidGeoHttpProxyDecorator: 130_201 ~ 130_250
  ANDROID_GEO_HTTP_PROXY_DECORATOR_PORT_PICK_ERROR(130_201, ErrorType.INFRA_ISSUE),
  ANDROID_GEO_HTTP_PROXY_DECORATOR_PROXY_START_ERROR(130_202, ErrorType.INFRA_ISSUE),
  ANDROID_GEO_HTTP_PROXY_DECORATOR_ADB_REVERSE_ERROR(130_203, ErrorType.INFRA_ISSUE),

  /** AndroidRuntimeStatsDecorator 130_251 ~ 130_260 */
  ANDROID_RUNTIME_STATS_DECORATOR_WRITE_REPORT_ERROR(130_251, ErrorType.INFRA_ISSUE),

  // AndroidBusinessLogicSkipModuleDecorator: 130_261 ~ 130_300
  ANDROID_BUSINESS_LOGIC_SKIP_MODULE_DECORATOR_SKIPPED(130_261, ErrorType.CUSTOMER_ISSUE),
  ANDROID_BUSINESS_LOGIC_SKIP_MODULE_DECORATOR_FETCH_ERROR(130_262, ErrorType.DEPENDENCY_ISSUE),
  ANDROID_BUSINESS_LOGIC_SKIP_MODULE_DECORATOR_FAIL(130_263, ErrorType.CUSTOMER_ISSUE),
  ANDROID_BUSINESS_LOGIC_SKIP_MODULE_DECORATOR_PARSE_JSON_ERROR(
      130_264, ErrorType.DEPENDENCY_ISSUE),

  // AndroidApkPreconditionCheckDecorator: 130_301 ~ 130_350
  ANDROID_APK_PRECONDITION_CHECK_DECORATOR_INVALID_PARAMETER(130_301, ErrorType.CUSTOMER_ISSUE),
  ANDROID_APK_PRECONDITION_CHECK_DECORATOR_APK_NOT_FOUND(130_302, ErrorType.DEPENDENCY_ISSUE),
  ANDROID_APK_PRECONDITION_CHECK_DECORATOR_TEST_FAILURE(130_303, ErrorType.CUSTOMER_ISSUE),

  // AndroidDeviceInfoCollectorDecorator: 130_351 ~ 130_400
  ANDROID_DEVICE_INFO_COLLECTOR_DECORATOR_INVALID_PARAMETER(130_351, ErrorType.CUSTOMER_ISSUE),
  ANDROID_DEVICE_INFO_COLLECTOR_DECORATOR_APK_NOT_FOUND(130_352, ErrorType.DEPENDENCY_ISSUE),
  ANDROID_DEVICE_INFO_COLLECTOR_DECORATOR_TEST_FAILURE(130_353, ErrorType.CUSTOMER_ISSUE),
  ANDROID_DEVICE_INFO_COLLECTOR_DECORATOR_PULL_FILE_ERROR(130_354, ErrorType.DEPENDENCY_ISSUE),

  // AndroidDisplayDeviceInfoDecorator: 130_401 ~ 130_450
  ANDROID_DISPLAY_DEVICE_INFO_DECORATOR_BOOTSTRAP_APK_NOT_FOUND(
      130_401, ErrorType.DEPENDENCY_ISSUE),
  ANDROID_DISPLAY_DEVICE_INFO_DECORATOR_BOOTSTRAP_INSTALL_ERROR(
      130_402, ErrorType.DEPENDENCY_ISSUE),
  ANDROID_DISPLAY_DEVICE_INFO_DECORATOR_BOOTSTRAP_START_ERROR(130_403, ErrorType.DEPENDENCY_ISSUE),

  // AndroidAflagsDecorator: 130_451 ~ 130_500
  ANDROID_AFLAGS_DECORATOR_FLAG_FORMAT_CHECK_FAILURE(130_451, ErrorType.CUSTOMER_ISSUE),
  ANDROID_AFLAGS_DECORATOR_FLAG_NOT_READ_WRITE(130_452, ErrorType.CUSTOMER_ISSUE),
  ANDROID_AFLAGS_DECORATOR_LIST_FLAGS_ERROR(130_453, ErrorType.INFRA_ISSUE),
  ANDROID_AFLAGS_DECORATOR_UPDATE_FLAG_ERROR(130_454, ErrorType.INFRA_ISSUE),
  ANDROID_AFLAGS_DECORATOR_REBOOT_ERROR(130_455, ErrorType.INFRA_ISSUE),
  ANDROID_AFLAGS_DECORATOR_FLAG_OVERRIDE_FORMAT_INVALID(130_456, ErrorType.CUSTOMER_ISSUE),
  ANDROID_AFLAGS_DECORATOR_FLAG_LIST_FORMAT_INVALID(130_457, ErrorType.INFRA_ISSUE),
  ANDROID_AFLAGS_DECORATOR_USER_BUILD_NOT_SUPPORTED(130_458, ErrorType.CUSTOMER_ISSUE),

  // Android Video Decorator: 130_501 ~ 130_550
  ANDROID_VIDEO_DECORATOR_EMULATOR_CONSOLE_FILE_ABSENT(130_501, ErrorType.INFRA_ISSUE),
  ANDROID_VIDEO_DECORATOR_EMULATOR_CONSOLE_FILE_EMPTY(130_502, ErrorType.INFRA_ISSUE),
  ANDROID_VIDEO_DECORATOR_WRITE_OUTPUT_ERROR(130_503, ErrorType.INFRA_ISSUE),

  // Android CDP Decorator: 130_551 ~ 130_600
  ANDROID_CDP_APP_LAUNCH_ERROR(130_551, ErrorType.DEPENDENCY_ISSUE),
  ANDROID_CDP_CHROMEDRIVER_ERROR(130_552, ErrorType.DEPENDENCY_ISSUE),
  ANDROID_CDP_FLAG_SETUP_ERROR(130_553, ErrorType.INFRA_ISSUE),
  ANDROID_CDP_PARAMETER_ERROR(130_554, ErrorType.CUSTOMER_ISSUE),
  ANDROID_CDP_PORT_ALLOCATION_ERROR(130_555, ErrorType.INFRA_ISSUE),
  ANDROID_CDP_PORT_FORWARD_ERROR(130_556, ErrorType.DEPENDENCY_ISSUE),
  ANDROID_CDP_SCRIPT_ERROR(130_557, ErrorType.CUSTOMER_ISSUE),
  ...
  ANDROID_INSTALL_APK_STEP_GMS_PACKAGING_NOT_SUPPORTED(134_904, ErrorType.CUSTOMER_ISSUE),
  ANDROID_INSTALL_APK_STEP_INVALID_APK_SET_ARCHIVE(134_905, ErrorType.CUSTOMER_ISSUE),
  ...
  // AndroidInstrumentationApkValidator: 135_501 ~ 135_520
  ANDROID_INSTRUMENTATION_APK_VALIDATOR_SPLIT_APK_MIXED_PACKAGE_NAMES(
      135_501, ErrorType.CUSTOMER_ISSUE),
  ANDROID_INSTRUMENTATION_APK_VALIDATOR_DUPLICATE_PACKAGE_NAME(135_502, ErrorType.CUSTOMER_ISSUE),
  ANDROID_INSTRUMENTATION_APK_VALIDATOR_MALFORMED_TEST_APK(135_503, ErrorType.CUSTOMER_ISSUE),
  ANDROID_INSTRUMENTATION_APK_VALIDATOR_MISSING_INSTRUMENTATION_TAG(
      135_504, ErrorType.CUSTOMER_ISSUE),
  ANDROID_INSTRUMENTATION_APK_VALIDATOR_TEST_RUNNER_NOT_FOUND(135_505, ErrorType.CUSTOMER_ISSUE),
  ANDROID_INSTRUMENTATION_APK_VALIDATOR_INSTRUMENTATION_TARGET_MISMATCH(
      135_506, ErrorType.CUSTOMER_ISSUE),
  ANDROID_INSTRUMENTATION_APK_VALIDATOR_MALFORMED_APK(135_507, ErrorType.CUSTOMER_ISSUE),
  ANDROID_INSTRUMENTATION_APK_VALIDATOR_DEVICE_ADMIN_NOT_ALLOWED(135_508, ErrorType.CUSTOMER_ISSUE),
  ANDROID_INSTRUMENTATION_APK_VALIDATOR_EXTRACT_PACKAGE_NAME_ERROR(
      135_509, ErrorType.CUSTOMER_ISSUE),
  ...
  XTS_DEVICE_COMPAT_CHECKER_DEVICE_AND_TOOL_INCOMPATIBLE(135_524, ErrorType.CUSTOMER_ISSUE),
  XTS_DEVICE_COMPAT_CHECKER_INVALID_VERSION_NUMBER(135_525, ErrorType.CUSTOMER_ISSUE),

  // AndroidVideoDecoratorProcessorPlugin: 135_541 ~ 135_560
  ANDROID_VIDEO_DECORATOR_PROCESSOR_PLUGIN_FFMPEG_RESOURCE_NOT_FOUND(
      135_541, ErrorType.INFRA_ISSUE),
  ANDROID_VIDEO_DECORATOR_PROCESSOR_PLUGIN_SANDBOX_RESOURCE_NOT_FOUND(
      135_542, ErrorType.INFRA_ISSUE),
  ...
  // AndroidScreenshotDecoratorEnvValidator: 146_101 ~ 146_120
  ANDROID_SCREENSHOT_DECORATOR_ENV_VALIDATOR_DEVICE_NOT_SUPPORTED(
      146_101, ErrorType.CUSTOMER_ISSUE),
  ...
  ANDROID_APK_INSTALLER_UNKNOWN_INSTALLABLE_ERROR(150_006, ErrorType.INFRA_ISSUE),
  ...
  ANDROID_BUNDLETOOL_COMMAND_EXEC_ERROR(150_902, ErrorType.UNDETERMINED),
  ANDROID_BUNDLETOOL_COMMAND_TIMEOUT(150_903, ErrorType.DEPENDENCY_ISSUE),
  ANDROID_BUNDLETOOL_EXTRACT_PACKAGE_NAME_IO_ERROR(150_904, ErrorType.INFRA_ISSUE),
  ANDROID_BUNDLETOOL_EXTRACT_PACKAGE_NAME_PARSING_ERROR(150_905, ErrorType.CUSTOMER_ISSUE),
  ...
  XTS_DYNAMIC_DOWNLOADER_PROPERTY_NOT_FOUND(175_007, ErrorType.INFRA_ISSUE),
  ...
  // Android Report Integrity Collector Decorator: 176_271 ~ 176_290
  ANDROID_REPORT_INTEGRITY_DECORATOR_SECURE_RANDOM_ERROR(176_271, ErrorType.INFRA_ISSUE),
  ANDROID_REPORT_INTEGRITY_DECORATOR_CSR_DECODE_ERROR(176_272, ErrorType.INFRA_ISSUE),
  ANDROID_REPORT_INTEGRITY_DECORATOR_CSR_CBOR_DECODE_ERROR(176_273, ErrorType.INFRA_ISSUE),
  ANDROID_REPORT_INTEGRITY_DECORATOR_CSR_CBOR_INVALID_STRUCTURE(176_274, ErrorType.INFRA_ISSUE),
  ANDROID_REPORT_INTEGRITY_DECORATOR_CSR_UNSUPPORTED_MAJOR_TYPE(176_275, ErrorType.INFRA_ISSUE),
  ...
  ANDROID_REPORT_INTEGRITY_DECORATOR_APK_NOT_FOUND(176_278, ErrorType.INFRA_ISSUE),
  ANDROID_REPORT_INTEGRITY_DECORATOR_DEVICE_INFO_PARSE_ERROR(176_279, ErrorType.INFRA_ISSUE),

  // System Vendor Reuse (SVR) plugin: 176_311 ~ 176_330
  SYSTEM_VENDOR_REUSE_PLUGIN_PROPERTY_NOT_FOUND(176_311, ErrorType.INFRA_ISSUE),
  SYSTEM_VENDOR_REUSE_PLUGIN_NO_CANDIDATE_MODULES(176_312, ErrorType.INFRA_ISSUE),
  SYSTEM_VENDOR_REUSE_PLUGIN_WRITE_SUBPLAN_ERROR(176_313, ErrorType.INFRA_ISSUE),
