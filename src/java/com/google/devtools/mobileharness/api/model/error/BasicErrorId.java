...
public enum BasicErrorId implements ErrorId {
  ...
  GOOGLE_FILE_READ_STRING_ERROR(30_301, ErrorType.UNDETERMINED),
  GOOGLE_FILE_READ_BYTES_ERROR(30_302, ErrorType.UNDETERMINED),
  GOOGLE_FILE_IS_DIR(30_303, ErrorType.UNDETERMINED),
  GOOGLE_FILE_GET_INSTANCE_ERROR(30_304, ErrorType.UNDETERMINED),
  GOOGLE_FILE_COPY_TO_LOCAL_ERROR(30_305, ErrorType.UNDETERMINED),
  GOOGLE_FILE_COPY_TO_REMOTE_ERROR(30_306, ErrorType.UNDETERMINED),
  GOOGLE_FILE_GET_SIZE_ERROR(30_307, ErrorType.UNDETERMINED),
  GOOGLE_FILE_GET_READABLE_FILE_CHANNEL_ERROR(30_308, ErrorType.UNDETERMINED),
  GOOGLE_FILE_MERGE_TO_REMOTE_ERROR(30_309, ErrorType.UNDETERMINED),
  GOOGLE_FILE_WRITE_TO_REMOTE_ERROR(30_310, ErrorType.UNDETERMINED),
  GOOGLE_FILE_GET_INPUT_STREAM_ERROR(30_311, ErrorType.UNDETERMINED),
  GOOGLE_FILE_CREATE_REMOTE_ERROR(30_312, ErrorType.UNDETERMINED),
  GOOGLE_FILE_SOURCE_NOT_ACCESSIBLE_WITH_TEST_LOAS(30_313, ErrorType.UNDETERMINED),

  GOOGLE_DIR_IS_FILE(30_401, ErrorType.UNDETERMINED),
  GOOGLE_DIR_CREATE_ERROR(30_402, ErrorType.UNDETERMINED),
  GOOGLE_DIR_SET_PERMISSION_ERROR(30_403, ErrorType.UNDETERMINED),
  GOOGLE_DIR_PREPARE_ERROR(30_404, ErrorType.UNDETERMINED),
  GOOGLE_DIR_PREPARE_PARENT_DIR_ERROR(30_405, ErrorType.UNDETERMINED),

  GOOGLE_FILE_OR_DIR_NOT_FOUND(30_451, ErrorType.UNDETERMINED),
  GOOGLE_FILE_OR_DIR_LIST_ERROR(30_452, ErrorType.UNDETERMINED),
  GOOGLE_FILE_OR_DIR_REMOVE_ERROR(30_453, ErrorType.UNDETERMINED),

  X20_FILE_RESOLVE_SYMBOL_LINK_ERROR(30_480, ErrorType.UNDETERMINED),
  X20_FILE_RESOLVE_DIR_ERROR(30_481, ErrorType.UNDETERMINED),
  ...
  // Build Rabbit: 31_621 ~ 31_650
  BUILD_RABBIT_CLOSE_RPC_ERROR(31_621, ErrorType.DEPENDENCY_ISSUE),
  BUILD_RABBIT_EXIT_ERROR(31_622, ErrorType.CUSTOMER_ISSUE),
  BUILD_RABBIT_NOT_FILE_GENERATED(31_623, ErrorType.UNDETERMINED),
  BUILD_RABBIT_FILE_DOWNLOAD_ERROR(31_624, ErrorType.UNDETERMINED),
  BUILD_RABBIT_GET_TARGET_INFO_ERROR(31_625, ErrorType.DEPENDENCY_ISSUE),
  BUILD_RABBIT_UNKNOWN_TARGET_TYPE(31_626, ErrorType.INFRA_ISSUE),
  BUILD_RABBIT_UNKNOWN_CHUNK(31_627, ErrorType.DEPENDENCY_ISSUE),
  BUILD_RABBIT_ILLEGAL_INVOCATION_STATE(31_628, ErrorType.UNDETERMINED),
  BUILD_RABBIT_ILLEGAL_CLIENT_STATE(31_629, ErrorType.INFRA_ISSUE),
  BUILD_RABBIT_ILLEGAL_CL_NUMBER(31_630, ErrorType.UNDETERMINED),
  BUILD_RABBIT_NULL_CLIENT_STATE(31_631, ErrorType.UNDETERMINED),
  BUILD_RABBIT_ILLEGAL_ARGUMENT(31_632, ErrorType.CUSTOMER_ISSUE),
  BUILD_RABBIT_FAIL_FETCH_CL_AND_BUILDID(21_633, ErrorType.UNDETERMINED),
  ...
  // Guitar: 32_201 ~ 32_250
  GUITAR_NULL_WORKSPACE_ERROR(32_201, ErrorType.DEPENDENCY_ISSUE),
  GUITAR_WORKSPACE_ENV_VAR_INVALID_VALUE(32_202, ErrorType.DEPENDENCY_ISSUE),
  GUITAR_FAIL_FETCH_INTEGRATION_ID(32_203, ErrorType.DEPENDENCY_ISSUE),
  ...
  // GCS file resolver, 32_301 ~ 32_400
  ...
  // MPM file resolver: 32_401 ~ 32_450
  MPM_PACKAGE_INFO_NO_VERSION(32_401, ErrorType.DEPENDENCY_ISSUE),
  MPM_PACKAGE_INFO_NO_SIZE(32_402, ErrorType.DEPENDENCY_ISSUE),
  MPM_FETCH_ILLEGAL_LOCAL_PATH(32_403, ErrorType.INFRA_ISSUE),
  MPM_FETCH_ERROR(32_404, ErrorType.INFRA_ISSUE),
  MPM_INVALID_SPEC(32_405, ErrorType.CUSTOMER_ISSUE),
  MPM_FETCH_FOUND_NO_MATCH_FILES_ERROR(32_406, ErrorType.CUSTOMER_ISSUE),
  MPM_GET_PACKAGE_DETAILS_FAILURE(32_407, ErrorType.DEPENDENCY_ISSUE),
  MPM_INSTALL_PACKAGE_FAILURE(32_408, ErrorType.DEPENDENCY_ISSUE),
  MPM_UNINSTALL_FAILURE(32_409, ErrorType.DEPENDENCY_ISSUE),

  // KOKORO file resolver: 32_451 ~ 32_500
  KOKORO_ILLEGAL_ARGUMENT(32_451, ErrorType.DEPENDENCY_ISSUE),
  KOKORO_NETWORK_ERROR(32_452, ErrorType.DEPENDENCY_ISSUE),
  KOKORO_SPEC_ILLEGAL_PARAM(32_453, ErrorType.CUSTOMER_ISSUE),
  KOKORO_SPEC_NO_JOB_NAME(32_454, ErrorType.CUSTOMER_ISSUE),
  KOKORO_BUILD_REQUEST_ERROR(32_455, ErrorType.UNDETERMINED),
  KOKORO_QUERY_REQUEST_ERROR(32_456, ErrorType.UNDETERMINED),

  // CATABUILDER file resolver: 32_501 ~ 32_550
  CATABUILDER_PARSE_SPEC_ERROR(32_501, ErrorType.CUSTOMER_ISSUE),
  CATABUILDER_LIST_ERROR(32_502, ErrorType.DEPENDENCY_ISSUE),
  CATABUILDER_FILE_NOT_FOUND(32_503, ErrorType.CUSTOMER_ISSUE),

  // GIT-ON-BORG file resolver: 32_551 ~ 32_600
  GITONBORG_RESOLVE_ERROR(32_551, ErrorType.DEPENDENCY_ISSUE),
  GITONBORG_ILLEGAL_ARGUMENT(33_552, ErrorType.CUSTOMER_ISSUE),

  // CATALOG file resolver: 32_601 ~ 32_650
  CATALOG_RESOLVE_ERROR(32_601, ErrorType.DEPENDENCY_ISSUE),
  CATALOG_ILLEGAL_ARGUMENT(32_602, ErrorType.CUSTOMER_ISSUE),
  CATALOG_APK_DOWNLOAD_ERROR(32_603, ErrorType.CUSTOMER_ISSUE),
  CATALOG_PARSE_SPEC_ERROR(32_604, ErrorType.CUSTOMER_ISSUE),

  // TAP: 32_651 ~ 32_700
  TAP_BUILD_ERROR(32_651, ErrorType.CUSTOMER_ISSUE),

  // Piper operation: 32_701 ~ 32_750
  PIPER_CREATE_WORKSPACE(32_701, ErrorType.DEPENDENCY_ISSUE),
  PIPER_WRITE_FILE(32_702, ErrorType.DEPENDENCY_ISSUE),
  PIPER_LIST_FILE(32_703, ErrorType.DEPENDENCY_ISSUE),
  PIPER_CREATE_CHANGE_LIST(32_704, ErrorType.DEPENDENCY_ISSUE),
  PIPER_UPDATE_FILE_STATE(32_705, ErrorType.DEPENDENCY_ISSUE),
  PIPER_SUBMIT(32_706, ErrorType.DEPENDENCY_ISSUE),
  PIPER_DUPLICATE_FILE_ID(32_707, ErrorType.CUSTOMER_ISSUE),
  PIPER_GET_HEAD_CL(32_708, ErrorType.DEPENDENCY_ISSUE),
  ...
  SPONGE_CREATE_INVOCATION_ERROR(33_001, ErrorType.UNDETERMINED),
  SPONGE_UPDATE_INVOCATION_ERROR(33_002, ErrorType.UNDETERMINED),
  SPONGE_FINALIZE_INVOCATION_ERROR(33_003, ErrorType.UNDETERMINED),
  SPONGE_RENDER_XML_ERROR(33_004, ErrorType.UNDETERMINED),
  SPONGE_PARSE_XML_ERROR(33_005, ErrorType.UNDETERMINED),
  SPONGE_GENERATOR_FAILED_TO_GET_JAR_URL(33_006, ErrorType.CUSTOMER_ISSUE),
  ...
  // Forge related: 33_301 ~ 33_350
  FORGE_FAIL_FETCH_BUILD_ID(33_301, ErrorType.DEPENDENCY_ISSUE),
