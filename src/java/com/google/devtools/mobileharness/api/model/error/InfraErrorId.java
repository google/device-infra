...
public enum InfraErrorId implements ErrorId {
  ...
  LAB_EXTERNAL_DEVICE_MANAGER_DEVICE_UNAVAILABLE_IN_TF(40_491, ErrorType.DEPENDENCY_ISSUE),
  LAB_EXTERNAL_DEVICE_MANAGER_RESERVE_RPC_DEADLINE_EXCEEDED(40_492, ErrorType.DEPENDENCY_ISSUE),
  LAB_EXTERNAL_DEVICE_MANAGER_RESERVE_RPC_ERROR(40_493, ErrorType.DEPENDENCY_ISSUE),
  LAB_EXTERNAL_DEVICE_MANAGER_RESERVE_TIMEOUT(40_494, ErrorType.DEPENDENCY_ISSUE),
  ...
  LAB_RPC_DEVICE_OPS_TAKE_SCREENSHOT_GRPC_ERROR(40_482, ErrorType.UNDETERMINED),
  LAB_RPC_DEVICE_OPS_GET_DEVICE_LOG_GRPC_ERROR(40_483, ErrorType.UNDETERMINED),
  LAB_RPC_DEVICE_OPS_GET_DEVICE_DEBUG_INFO_GRPC_ERROR(40_484, ErrorType.UNDETERMINED),
  LAB_RPC_DEVICE_OPS_TAKE_SCREENSHOT_STUBBY_ERROR(40_485, ErrorType.UNDETERMINED),
  LAB_RPC_DEVICE_OPS_GET_DEVICE_LOG_STUBBY_ERROR(40_486, ErrorType.UNDETERMINED),
  LAB_RPC_DEVICE_OPS_GET_DEVICE_DEBUG_INFO_STUBBY_ERROR(40_487, ErrorType.UNDETERMINED),
  ...
  MASTER_RPC_STUB_LAB_SYNC_REMOVE_MISSING_HOST_ERROR(49_292, ErrorType.INFRA_ISSUE),
  ...
  LAB_RPC_PREPARE_TEST_LEASE_DEVICE_CACHE_STUBBY_ERROR(49_327, ErrorType.INFRA_ISSUE),
  LAB_RPC_PREPARE_TEST_LEASE_DEVICE_CACHE_GRPC_ERROR(49_328, ErrorType.INFRA_ISSUE),
  LAB_RPC_PREPARE_TEST_RELEASE_DEVICE_CACHE_STUBBY_ERROR(49_329, ErrorType.INFRA_ISSUE),
  LAB_RPC_PREPARE_TEST_RELEASE_DEVICE_CACHE_GRPC_ERROR(49_330, ErrorType.INFRA_ISSUE),
  ...
  CLIENT_REMOTE_MODE_TEST_CREATE_DEPENDENCY_ERROR(49_613, ErrorType.DEPENDENCY_ISSUE),
  ...
  CLIENT_REMOTE_MODE_JOB_SEND_FILE_ERROR_GCS_PERMISSION_DENIED(49_647, ErrorType.CUSTOMER_ISSUE),
  CLIENT_REMOTE_MODE_JOB_SEND_FILE_ERROR_GCS_NETWORK_ISSUE(49_648, ErrorType.DEPENDENCY_ISSUE),
  CLIENT_REMOTE_MODE_JOB_SEND_FILE_ERROR_FILE_NOT_FOUND(49_649, ErrorType.CUSTOMER_ISSUE),
  CLIENT_REMOTE_MODE_JOB_OPEN_ERROR_PERMISSION_DENIED(49_650, ErrorType.CUSTOMER_ISSUE),
  ...
  FT_RPC_STUB_CANCEL_PROCESS_ERROR(50_658, ErrorType.INFRA_ISSUE),
  ...
  OLCS_QUERY_DEVICE_ERROR(52_227, ErrorType.INFRA_ISSUE),
  OLCS_UPSERT_TEMP_REQUIRED_DIMENSIONS_DEVICE_NOT_FOUND(52_228, ErrorType.CUSTOMER_ISSUE),
  OLCS_DEVICE_CACHE_LEASE_ERROR(52_229, ErrorType.UNDETERMINED),
  OLCS_DEVICE_CACHE_RELEASE_ERROR(52_230, ErrorType.UNDETERMINED),
  ...
  ATS_SERVER_RESTORE_CHUNKED_TEST_CASES_ERROR(52_708, ErrorType.UNDETERMINED),
