...
/**
 * Event which signals that the ending process of a local test is going to start.
 *
 ...
 */
public interface LocalTestEndingEvent extends TestEndingEvent, DeviceFeaturedEvent {}
