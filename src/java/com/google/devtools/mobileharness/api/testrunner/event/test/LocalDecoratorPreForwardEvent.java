...
/**
 * Event which signals that a decorator is going to forward a request of {@code run()} (invoking its
 ...
 */
public interface LocalDecoratorPreForwardEvent extends DriverEvent {}
