...
/**
 * Event which signals that a decorator has forwarded a request of {@code run()} (invoking its
 * {@code getDecorated().run()}).
 *
 ...
 */
public interface LocalDecoratorPostForwardEvent extends DriverEvent, ExecutionEndEvent {}
