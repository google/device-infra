...
public abstract class JavaCommandCreator {
   ...
   *
   * @param useStandardInvocationForm if {@code true}, use the standard Java invocation form to
   *     create a Java command. If {@code false}, direct Java invocation</a> instead.
