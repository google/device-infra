...
package com.google.devtools.deviceinfra.shared.util.command.backend;

import static com.google.common.base.Preconditions.checkNotNull;
import static com.google.common.base.Preconditions.checkState;
import static com.google.common.time.Durations.toNanosSaturated;
...
final class AtomicResult {
  ...
  CommandResult await(Duration timeout)
    ...
    if (monitor.enterWhen(processComplete, toNanosSaturated(timeout), NANOSECONDS)) {
      try {
        return getOrThrow();
      } finally {
        monitor.leave();
