...
package com.google.devtools.deviceinfra.shared.logging.controller.uploader.stackdriver.stub;
...
import com.google.devtools.deviceinfra.shared.logging.annotation.Annotations.StackdriverSecretFileName;
...
/** Stub of UDCluster Stackdriver Logging. */
public class StackdriverStub {
  ...
  @Inject
  public StackdriverStub(@StackdriverSecretFileName String secretFileName) {
  ...
  public void init() throws MobileHarnessException {
    ...
    interceptors.add(ChannelFactory.authorityInterceptor(LOGGING_SERVICE_TARGET));
    interceptors.add(
        ChannelFactory.credentialInterceptor(new File(clientSecretFilePath), WRITE_SCOPES));
