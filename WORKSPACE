...
maven_install(
    artifacts = [
        ...
        #"com.google.cloud:google-cloud-logging:3.16.2",
        "com.google.api.grpc:grpc-google-cloud-logging-v2:0.105.2",
        "com.google.api.grpc:proto-google-cloud-logging-v2:0.105.2",
